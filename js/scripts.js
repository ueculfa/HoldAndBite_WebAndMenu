...
// Toggle Location Cards
$(document).ready(function() {
    $('.toggle-map').on('click', function(e) {
        e.preventDefault();
        $('.locations-cards-container').toggleClass('active');
        var isActive = $('.locations-cards-container').hasClass('active');
        $(this).text(isActive ? 'Haritaları Gizle' : 'Haritaları Göster/Gizle');
    });
});